          ...
          <div className="hero-layout">
            <div className="hero-content">
              ...
              <p className="hero-description">
                Roots turns scattered photos, stories, and DNA results into one living, interactive family hub—beautiful, private, and built for generations.
              </p>
              ...
              <div className="hero-trust">
                ...
                <span className="trust-text">No credit card · Invite your whole family in minutes</span>
              </div>
            </div>
            <div className="hero-visual">
              <div className="hero-image">
                <img src="https://images.unsplash.com/photo-1511895426328-dc8714191300?w=600&h=400&fit=crop&crop=faces" alt="Happy family" />
                <div className="hero-notification">
                  <div className="notification-avatar">
                    <img src="https://i.pravatar.cc/40?img=5" alt="User" />
                  </div>
                  <div className="notification-content">
                    <div className="notification-title">New cousin matched</div>
                    <div className="notification-subtitle">4th generation · 2 shared ancestors</div>
                  </div>
                  <button className="notification-button">Live tree</button>
                </div>
              </div>
            </div>
          </div>
