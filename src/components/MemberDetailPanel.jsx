...
function MemberDetailPanel({ 
  ...
  const relatedMembers = useMemo(() => {
    ...
    relationships.forEach(rel => {
      ...
      if (relatedMemberId && !relatedIds.has(relatedMemberId)) {
...
MemberDetailPanel.propTypes = {
  ...
  onAddRelativeClick: PropTypes.func.isRequired,
  onRelatedMemberClick: PropTypes.func.isRequired,
  onTracePath: PropTypes.func.isRequired,
};

MemberDetailPanel.defaultProps = {
  selectedMember: null,
  allMembers: [],
  relationships: [],
  treeOwner: null,
