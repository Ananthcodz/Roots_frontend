...
describe('dashboardSlice', () => {
  ...
  describe('refreshDashboard async thunk', () => {
    const mockDashboardData = {
      ...
      recentUpdates: [{ id: 'new-update' }],
      upcomingEvents: [{ id: 'new-event' }],
      memorySpotlight: { id: 'new-memory' },
      treeStats: {
        memberCount: 5,
        generationCount: 3,
      },
      onlineUsers: [{ id: 'user-1' }],
    };
  ...
  describe('selectors', () => {
    const mockDashboardData = {
      ...
      recentUpdates: [{ id: 'update-1' }],
      upcomingEvents: [{ id: 'event-1' }],
      treeStats: { memberCount: 10 },
    };
    ...
    describe('selectSectionLoading', () => {
      ...
      it('should return false for non-existent section', () => {
        expect(selectSectionLoading(mockState, 'nonExistentSection')).toBeUndefined();
      });
    ...
    describe('selectSectionError', () => {
      ...
      it('should return undefined for non-existent section', () => {
        expect(selectSectionError(mockState, 'nonExistentSection')).toBeUndefined();
      });
      ...
      it('should handle null and undefined section parameters', () => {
        expect(selectSectionError(mockState, null)).toBeUndefined();
        expect(selectSectionError(mockState, undefined)).toBeUndefined();
      });
    });
  });
