...
// Selectors
export const selectSelectedMemberId = (state) => state.tree.selectedMemberId;
export const selectSearchQuery = (state) => state.tree.searchQuery;
export const selectSearchResults = (state) => state.tree.searchResults;
export const selectZoomLevel = (state) => state.tree.zoomLevel;
export const selectPanOffset = (state) => state.tree.panOffset;
export const selectShowTooltip = (state) => state.tree.showFirstTimeTooltip;
